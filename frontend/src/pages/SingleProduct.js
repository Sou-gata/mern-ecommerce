...
const SingleProduct = () => {
    ...
    return (
        <>
                        ...
                        <div className="col-6">
                            <div className="main-product-details">
                                <div className="border-bottom">
                                    <h3 className="title">
                                        Samsung Galaxy S20 FE 5G (Cloud
                                        Lavender, 8GB RAM, 128GB Storage)
                                    </h3>
                                </div>
                                            ...
                                            <AccordionDetails className="bg-accordion">
                                                <ul className="product-data">
                                                    ...
                                                    <li>
                                                        ...
                                                        ports, microphones,
                                                        speakers, and other
                                                        areas that liquid can
                                                        seep into.
                                                    </li>
                                                    <li>
                                                        Don’t spray, pour, or
                                                        dip your device directly
                                                        into any liquids.
                                                        Instead, use a small
                                                        corner of a cloth to
                                                        apply the product.
                                                    </li>
                                                    <li>
                        ...
                        <div className="col-12">
                            ...
                            <div className="bg-white p-3">
                                <p>
                                    ...
                                    obcaecati a accusamus ex accusantium
                                    quisquam omnis impedit tempore modi placeat
                                    enim optio, rem unde! Consequuntur, hic ut!
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="reviews-wrapper pb-3 home-wrapper-2">
                <div className="container-xxl">
                    <div className="row">
                        <div className="col-12">
                                ...
                                <div className="reviews">
                                    <div className="review">
                                        ...
                                        <p>
                                            ...
                                            Aliquam minima, libero porro atque
                                            explicabo a doloremque ex totam
                                            maiores amet sed non suscipit eius
                                            labore soluta adipisci id
